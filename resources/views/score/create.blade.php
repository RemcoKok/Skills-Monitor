        ...
        <div class="col-sm-3 invoice-col">
            ...
            <p>
                ...
                <h5><strong>Hou het kort en krachtig</strong></h5>
                    ...
                    <br>
                    &emsp;// Deze tekst is een placeholder voor het mogelijk maken van  <br>
                    &emsp;toevoegen van tekst, zonder dat de hele site zal verschuiven <br>
                    &emsp;door het toevoegen van tekst, als dat een beetje logisch klinkt. //<br>
            </p>
        </div>
